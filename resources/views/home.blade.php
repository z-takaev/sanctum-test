...
<div
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <div class="flex">
                    <a href="{{ route('home') }}" class="mr-2 text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
                    <form action="/logout" method="post">
                        @csrf
                        <input class="text-sm text-gray-700 dark:text-gray-500 underline" type="submit" value="logout">
                    </form>
                </div>
            @else
